...
const privacy = () => {
    return (
        <Container fluid>            
            <Row>
                <Col className="p-0 policy_header_col">
                    <header className="py-3 policy_header">
            ...
            <Row>
                <Col className="p-0">
                    <section className="py-4 policy_content" >
                        <h2>Interpretation and Definitions</h2>
                        <hr />

                        <div className="my-4 policy_content_section">
                        ...
                        <div className="my-4 policy_content_section">
                            ...
                            <ul>
                                ...
                                <li><b>Affiliate</b> means an entity that controls, is controlled by or is under common control
                                ...
                                <li><b>Application</b> means the software program provided by the Company downloaded by
                                    You on any electronic device, named Fluxx Charter</li>
                                <li><b>Business</b>, for the purpose of the CCPA (California Consumer Privacy Act), refers to
                                ...
                                <li><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this
                                    Agreement) refers to Irreverent Rogue LLC, 6545 MARKET AVE. NORTH STE 100,
                                    North Canton, OH 44721.
                                    <p>For the purpose of the GDPR, the Company is the Data Controller</p> </li>
                                <li><b>Consumer</b> for the purpose of the CCPA (California Consumer Privacy Act), means a
                                    ...
                                    outside the USA for a temporary or transitory purpose</li>
                                <li><b>Cookies</b> are small files that are placed on Your computer, mobile device or any
                                ...
                                <li><b>Data Controller</b> for the purposes of the GDPR (General Data Protection
                                ...
                                <li><b>Do Not Track</b> (DNT) is a concept that has been promoted by US regulatory
                                    ...
                                    control the tracking of their online activities across websites.</li>
                                <li><b>Personal Data</b> a is any information that relates to an identified or identifiable individual. 
                                    <p>For the purposes for GDPR, Personal Data means any information relating to You
                                    ...
                                    linked, directly or indirectly, with You.</li>
                                <li><b>Sale</b>,  for the purpose of the CCPA (California Consumer Privacy Act), means selling,
                                    ...
                                    or other valuable consideration.</li>
                                <li><b>Service</b> refers to the Application or the Website or both.</li>
                                <li><b>Service Provider</b> means any natural or legal person who processes the data on
                                    ...
                                    are considered Data Processors.</li>
                                <li><b>Third-party Social Media Service</b> refers to any website or any social network
                                    ...
                                    visit).</li>
                                <li><b>Website</b> refers to Fluxx Charter, accessible from https://www.fluxxcharter.com</li>
                                <li><b>You</b> means the individual accessing or using the Service, or the company, or other
                                    legal entity on behalf of which such individual is accessing or using the Service, as
                                    applicable.
                                    <p>Under GDPR (General Data Protection Regulation), You can be referred to as the
                                    Data Subject or as the User as you are the individual using the Service.</p></li>
                            </ul>
                        </div>
                    </section>
                </Col>
            ...
            <Row>
                <Col className="p-0">
                    <section className="py-4 policy_content" >
                        <h2>Collecting and Using Your Personal Datas</h2>
                        <hr />
                        ...
                        <div className="my-4 policy_content_section">
                            ...
                            <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your
                                ...
                                as soon as You close Your web browser. Learn more about cookies: What Are Cookies?.</p>
                        ...
                        <div className="my-4 policy_content_section">
                            <ul>
                                ...
                                <li>Purpose: These Cookies are essential to provide You with services available through
                                    ...
                                    to provide You with those services.</li>
                            </ul>
                            <ul>
                            ...
                            <ul>
                                ...
                                <li>Type: Persistent Cookies</li>
                                <li>Administered by: Us</li>
                                <li>Purpose: These Cookies allow us to remember choices You make when You use the
                            ...
                            <ul>
                                ...
                                <li>Administered by: Us</li>
                                <li>Purpose: These Cookies are used to track information about traffic to the Website
                        ...
                        <div className="my-4 policy_content_section">
                            ...
                            <ul>
                                ...
                                <li><b>To provide You</b> with news, special offers and general information about other
                ...
                <Col className="p-0">
                    <section className="py-4 policy_content" >
                        ...
                        <div className="my-4 policy_content_section">                            
                            ...
                            <ul>
                                <li><b>Google Analytics</b> is a web analytics service offered by Google that tracks and reports
                                    ...
                                    provided by Google in their Privacy Policy: <a href="https://policies.google.com/privacy" target="_blank">https://policies.google.com/privacy </a> 
                                     For more information on the privacy practices of Google, please visit the Google
                                    Privacy & Terms web page: <a href="https://policies.google.com/privacy" target="_blank">https://policies.google.com/privacy</a></li>
                            </ul>
                        </div>
                    </section>
                </Col>
                    ...
                    <section className="py-4 policy_content" >
                        ...
                        <div className="my-4 policy_content_section">                            
                            ...
                            <ul>
                                ...
                                <li><b>Performance of a contract:</b> Provision of Personal Data is necessary for the
                                ...
                                <li><b>Vital interests:</b> Processing Personal Data is necessary in order to protect Your vital
                                    interests or of another natural person.</li>
                                <li><b>Public interests:</b> Processing Personal Data is related to a task that is carried out in the
                                    public interest or in the exercise of official authority vested in the Company.</li>
                                <li><b>Legitimate interests:</b> Processing Personal Data is necessary for the purposes of the
                        ...
                        <div className="my-4 policy_content_section">                            
                            ...
                            <p>The Company undertakes to respect the confidentiality of Your Personal Data and to
                            ...
                            <ul>
                                <li><b>Request access to Your Personal Data.</b>The right to access, update or delete the
                                    ...
                                    also enables You to receive a copy of the Personal Data We hold about You.</li>
                                ...
                                <li><b>Object to processing of Your Personal Data.</b>This right exists where We are relying on
                                    ...
                                    Your Personal Data for direct marketing purposes.</li>
                                ...
                                <li><b>Request the transfer of Your Personal Data.</b>We will provide to You, or to a thirdparty You have chosen, Your Personal Data in a structured, commonly used, machinereadable format. Please note that this right only applies to automated information
                        ...
                        <div className="my-4 policy_content_section">                            
                            ...
                            <p>You may exercise Your rights of access, rectification, cancellation and opposition by
                                ...
                                possible.</p>
                            <p>You have the right to complain to a Data Protection Authority about Our collection and use
            ...
            <Row>
                <Col className="p-0">
                    <section className="py-4 policy_content" >
                        <h2>CCPA Privacy</h2>
                        <hr />
                        <p>This privacy notice section for California residents supplements the information contained
                        ...
                        <div className="my-4 policy_content_section">                            
                            ...
                            <p>We collect information that identifies, relates to, describes, references, is capable of being
                                ...
                                months.</p>
                            <p>Please note that the categories and examples provided in the list below are those defined in
                            ...
                            <ul>
                                ...
                                <li><b>Category B: Personal information categories listed in the California Customer
                                    Records statute (Cal. Civ. Code § 1798.80(e)).</b><br />
                                ...
                                <li><b>Category C: Protected classification characteristics under California or federal
                                    law.</b><br />
                                ...
                                <li><b>Category J: Non-public education information (per the Family Educational
                                    Rights and Privacy Act (20 U.S.C. Section 1232g, 34 C.F.R. Part 99)).</b><br />
                                ...
                                <li>Information excluded from the CCPA's scope, such as:
                                    <ul style={{listStyleType: "disc"}}>
                                        <li>Health or medical information covered by the Health Insurance Portability and
                                            ...
                                            Information Act (CMIA) or clinical trial data</li>
                        ...
                        <div className="my-4 policy_content_section">                            
                            ...
                            <ul style={{listStyleType: "disc"}}>
                                <li><b>Directly from You.</b> For example, from the forms You complete on our Service,
                                    preferences You express or provide through our Service.</li>
                                <li><b>Indirectly from You.</b>For example, from observing Your activity on our Service.</li>
                                <li><b>Automatically from You.</b>For example, through cookies We or our Service Providers
                                    set on Your Device as You navigate through our Service</li>
                                <li><b>From Service Providers.</b> For example, third-party vendors to monitor and analyze the
                                    use of our Service, or other third-party vendors that We use to provide the Service to You.</li>                                
                            </ul>
                        </div>
                        <div className="my-4 policy_content_section">                            
                            <strong>Use of Personal Information for Business Purposes or Commercial Purposes</strong>
                            <p>We may use or disclose personal information We collect for "business purposes" or
                                "commercial purposes" (as defined under the CCPA), which may include the following
                                examples:</p>
                            <ul style={{listStyleType: "disc"}}>
                                <li>To operate our Service and provide You with our Service.</li>
                                <li>To provide You with support and to respond to Your inquiries, including to investigate
                                    and address Your concerns and monitor and improve our Service.</li>
                                <li>To fulfill or meet the reason You provided the information. For example, if You share
                                    Your contact information to ask a question about our Service, We will use that personal
                                    information to respond to Your inquiry.</li>
                                <li>As described to You when collecting Your personal information or as otherwise set forth
                                    in the CCPA</li>
                                <li>For internal administrative and auditing purposes.</li>
                                <li>To detect security incidents and protect against malicious, deceptive, fraudulent or
                                    illegal activity, including, when necessary, to prosecute those responsible for such
                                    activities.</li>
                            </ul>
                            <p>Please note that the examples provided above are illustrative and not intended to be
                                exhaustive. For more details on how we use this information, please refer to the "Use of
                                Your Personal Data" section.</p>
                            <p>If We decide to collect additional categories of personal information or use the personal
                                information We collected for materially different, unrelated, or incompatible purposes We
                                will update this Privacy Policy.</p>
                        </div>
                        <div className="my-4 policy_content_section">                            
                            <strong>Disclosure of Personal Information for Business Purposes or Commercial Purposes</strong>
                            <p>We may use or disclose and may have used or disclosed in the last twelve (12) months the
                                following categories of personal information for business or commercial purposes:</p>
                            <ul>
                                <li>Category A: Identifiers</li>
                                <li>Category B: Personal information categories listed in the California Customer </li>
                                <li>Records statute (Cal. Civ. Code § 1798.80(e))</li>
                                <li>Category F: Internet or other similar network activity</li>
                            </ul>
                            <p>Please note that the categories listed above are those defined in the CCPA. This does not
                            ...
                            <p>When We disclose personal information for a business purpose or a commercial purpose,
                        ...
                        <div className="my-4 policy_content_section">                            
                            ...
                            <p>As defined in the CCPA, "sell" and "sale" mean selling, renting, releasing, disclosing,
                                ...
                                kind of benefit in return for sharing personal Iinformation, but not necessarily a monetary
                                benefit.</p>
                            <p>Please note that the categories listed below are those defined in the CCPA. This does not
                                mean that all examples of that category of personal information were in fact sold, but
                                reflects our good faith belief to the best of our knowledge that some of that information
                                from the applicable category may be and may have been shared for value in return.</p>
                            <p>We may sell and may have sold in the last twelve (12) months the following categories of
                        ...
                        <div className="my-4 policy_content_section">                            
                            ...
                            <p>We may share Your personal information identified in the above categories with the
                        ...
                        <div className="my-4 policy_content_section">                            
                            ...
                            <p>We do not sell the personal information of Consumers We actually know are less than 16
                                ...
                                Your authorized representative) may submit a request to Us by contacting Us.</p>
                        ...
                        <div className="my-4 policy_content_section">                            
                            ...
                            <p>The CCPA provides California residents with specific rights regarding their personal
                                information. If You are a resident of California, You have the following rights:</p>
                            <ul style={{listStyleType: "disc"}}>
                                <li><b>The right to notice.</b> You have the right to be notified which categories of Personal Data
                                    are being collected and the purposes for which the Personal Data is being used.</li>
                                <li><b>The right to request.</b> Under CCPA, You have the right to request that We disclose
                                ...
                                <li><b>The right to say no to the sale of Personal Data (opt-out).</b> You have the right to
                                        direct Us to not sell Your personal information. To submit an opt-out request please contact Us.</li>
                                <li><b>The right to delete Personal Data.</b> You have the right to request the deletion of Your
                                    ...
                                    <ul style={{listStyleType: "disc"}}>
                                        ...
                                        <li>Engage in public or peer-reviewed scientific, historical, or statistical research in the
                                            ...
                                            research's achievement, if You previously provided informed consent</li>
                                ...
                                <li><b>The right not to be discriminated against</b> You have the right not to be discriminated
                        ...
                        <div className="my-4 policy_content_section">                            
                            <strong>Exercising Your CCPA Data Protection Rights</strong>
                            <p>In order to exercise any of Your rights under the CCPA, and if You are a California resident,
                                You can contact Us:</p>
                            <ul>
                                <li>By email: contact@fluxxcharter.com</li>                                
                            </ul>
                            <p>Only You, or a person registered with the California Secretary of State that You authorize to
                                act on Your behalf, may make a verifiable request related to Your personal information.</p>
                            <p>Your request to Us must:</p>
                            <ul>
                                <li>Provide sufficient information that allows Us to reasonably verify You are the person
                            ...
                            <p>We will disclose and deliver the required information free of charge within 45 days of
                                ...
                                notice.</p>
                            <p>Any disclosures We provide will only cover the 12-month period preceding the verifiable
                                request's receipt.</p>
                            <p>For data portability requests, We will select a format to provide Your personal information
                        ...
                        <div className="my-4 policy_content_section">                            
                            ...
                            <p>You have the right to opt-out of the sale of Your personal information. Once We receive and
                            ...
                            <p>The Service Providers we partner with (for example, our analytics or advertising partners)
                            ...
                            <p>Please note that any opt out is specific to the browser You use. You may need to opt out on
                                every browser that You use.</p>
                        </div>
                        <div className="my-4 policy_content_section">
                            <strong>Website</strong>
                            <p>You can opt out of receiving ads that are personalized as served by our Service Providers by
                                following our instructions presented on the Service:</p>
                                <ul style={{listStyleType: "disc"}}>
                        ...
                        <div className="my-4 policy_content_section">
                            ...
                            <p>Your mobile device may give You the ability to opt out of the use of information about the
                                apps You use in order to serve You ads that are targeted to Your interests:</p>
                                <ul style={{listStyleType: "disc"}}>
                ...
                <Col className="p-0">
                    <section className="py-4 policy_content" >
                        ...
                        <div className="my-4 policy_content_section">                            
                            ...
                            <p>However, some third party websites do keep track of Your browsing activities. If You are
                ...
                <Col className="p-0">
                    <section className="py-4 policy_content" >
                        ...
                        <div className="my-4 policy_content_section">                            
                            ...
                            <p>If you'd like to request more information under the California Shine the Light law, and if You
                ...
                <Col className="p-0">
                    <section className="py-4 policy_content" >
                        ...
                        <div className="my-4 policy_content_section">                            
                            ...
                            <p>To request removal of such data, and if You are a California resident, You can contact Us
                                using the contact information provided below, and include the email address associated with Your account.</p>
                            <p>Be aware that Your request does not guarantee complete or comprehensive removal of
                                content or information posted online and that the law may not permit or require removal in certain circumstances.</p>
                        </div>                        
                    </section>
                </Col>
            </Row>
