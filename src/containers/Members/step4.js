          ...
          <Col xs={1} md={5} className="project_details m-2">
            ...
            <Form>
              <Form.Group controlId="exampleForm.ControlTextarea1">
                <Form.Label className="form-labels">What do you hope to accomplish
                with this project? What do you hope to gain or retain with this effort? </Form.Label>
                <Form.Control as="textarea" rows={4} name="goal" value={goal} onChange={setForm} />
              </Form.Group>
