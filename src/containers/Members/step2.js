          ...
          <Col xs={1} md={5} className="project_details m-2">
            ...
            <Form>
              <Form.Group controlId="exampleForm.ControlTextarea1">
                <Form.Label className="form-labels">Who will be the Project Manager? </Form.Label>
                <Form.Control as="textarea" rows={2} name="project_sponsor"
                  value={project_manager}
                  onChange={setForm} />
              </Form.Group>

              <Form.Group controlId="exampleForm.ControlTextarea1">
                <Form.Label className="form-labels">Who is the Project Sponsor?</Form.Label>
                <Form.Control as="textarea" rows={2} name="project_sponsor" 
